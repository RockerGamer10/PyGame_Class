...
font2 = pygame.font.SysFont('cursive', 18)
...
class Tetramino:
	...
	FIGURES = {
        ...
        'Z' : [[4, 5, 9, 10], [2, 6, 5, 9]],
        'S' : [[6, 7, 9, 10], [1, 5, 6, 10]],
        'J' : [[1, 5, 9, 8], [0, 4, 5, 6], [1, 2, 5, 9], [4, 5, 6, 10]],
        'L' : [[2, 6, 10, 11], [5, 6, 7, 9], [1, 2, 6, 10], [3, 5, 6, 7]],
        'T' : [[1, 4, 5, 6], [1, 5, 6, 9], [4, 5, 6, 9], [1, 4, 5, 9]],
        'O' : [[1, 2, 5, 6]],
		'B' : [[1, 5, 6, 9, 10], [5, 6, 7, 9, 10], [1, 2, 5, 6, 10], [1, 2, 4, 5, 6]],
		'D' : [[2, 5, 6, 9, 10], [5, 6, 9, 10, 11], [1, 2, 5, 6, 9], [0, 1, 2, 5, 6]],
		'-' : [[1, 5], [5, 6]]
	}

	TYPES = ['I', 'Z', 'S', 'L', 'J', 'T', 'O', 'B', 'D', '-']
...
while running:
	...
	win.blit(scoreimg, (150-scoreimg.get_width()//2, HEIGHT-110))
	win.blit(levelimg, (150-levelimg.get_width()//2, HEIGHT-30))
